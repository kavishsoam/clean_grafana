...
// // Utils & Services
import { dedupAnnotations } from './reply_processing';
// // Types
...
import { ReplyQueryOptions, ReplyQueryResponse } from './type';
...
export class ReplyService {
  ...
  getAnnotations(options: ReplyQueryOptions) {
  ...
  getGlobalAnnotations(options: ReplyQueryOptions) {
...
export function executeAnnotationQuery(
  options: ReplyQueryOptions,
  datasource: DataSourceApi,
  savedJsonAnno: any
): Observable<ReplyQueryResponse> {
  const processor = {
...
coreModule.service('replyService', ReplyService);
