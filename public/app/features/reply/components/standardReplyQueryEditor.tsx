...
import { standardReplySupport } from '../standardReplySupport';
import { executeAnnotationQuery } from '../reply_service';
import { PanelModel } from 'app/features/dashboard/state';
import { ReplyQueryResponse } from '../type';
import { AnnotationFieldMapper } from './ReplyResultMapper';
...
export default class StandardReplyQueryEditor extends PureComponent<Props, State> {
  state = {} as State;
...
coreModule.directive('standardReplyEditor', [
  'reactDirective',
  (reactDirective: any) => {
    return reactDirective(StandardReplyQueryEditor, ['annotation', 'datasource', 'change']);
  },
]);
