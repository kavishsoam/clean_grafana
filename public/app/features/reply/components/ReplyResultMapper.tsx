...
import { ReplyEventNames, ReplyFieldInfo } from '../standardReplySupport';
...
export class AnnotationFieldMapper extends PureComponent<Props, State> {
  ...
  renderRow(row: ReplyFieldInfo, mapping: AnnotationEventFieldMapping, first?: AnnotationEvent) {
