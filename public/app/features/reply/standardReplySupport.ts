...
export const standardReplySupport: AnnotationSupport = {
  /**
...
export interface ReplyFieldInfo {
  key: keyof AnnotationEvent;
...
export const ReplyEventNames: ReplyFieldInfo[] = [
  {
    key: 'time',
...
export function getAnnotationsFromData(
  ...
  return of(data).pipe(
    ...
    map(frame => {
      ...
      for (const evts of ReplyEventNames) {
